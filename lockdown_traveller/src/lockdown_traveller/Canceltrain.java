...
public class Canceltrain extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(trainnum, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            dout.writeUTF(trainnum.getText());
            String df="";
        DateFormat df1;
        df1 = new SimpleDateFormat("dd-MM-yyyy");
        df=df1.format(date.getDate());
            dout.writeUTF(df);
            String s3;
            s3=din.readUTF();
            if(s3.equalsIgnoreCase("1")){
                JOptionPane.showMessageDialog(null, "No such train found!!");
            }
            else{
